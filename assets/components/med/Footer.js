                    ...
                    <div className="row">
                        <div className="footer-main-content-elements">
                            <div className="footer-main-content-element col-md-3 col-sm-6">
                                ...
                                <h3 className="widget-title uni-uppercase text-center">Médecins <span>libéraux de France</span></h3>
                                    <div className="widget-title uni-uppercase">
                                    <a href="#top" className="row text-white h1"><hr/><i className="fas fa-hand-holding-medical"></i><hr/></a></div>
                            ...
                            <div className="footer-main-content-element col-md-6 col-sm-12">
                                ...
                                <aside className="widget">
                                    ...
                                    <div className="text-white text-center">L’ensemble des données est disponible en open data sur ce lien : 
                                    <a href="https://data.opendatasoft.com/explore/dataset/medecins%40public/table/?flg=fr"> https://data.opendatasoft.com/explore/dataset/medecins%40public/table/?flg=fr </a>
